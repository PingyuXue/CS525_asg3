...
typedef struct BM_PageHandle {
  ...
  int fixCount; // count how many clients are using this page.
  int *strategyType; // record attribution for strategy, like midify time or create time.
} BM_PageHandle;
...
typedef struct BM_BufferPool {
  ...
  int numRead; // the number of read from page file.                
  int numWrite; // the number of write from page file.                               
  int time; // modify/create time.
} BM_BufferPool;
